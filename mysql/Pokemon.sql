...
/**('编号','#编号','日文','英文','属性1 ','属性2 ','特性1','特性2','隐藏特性','身高m','体重kg','描述','img/Pokemon/'),**/
	...
	(NULL,'#006','喷火龙','リザードン','Charizard','火','飞','猛火',NULL,'太阳之力','1.7m','90.5kg','喷火龙在空中飞翔，寻找强大的对手。它吐出的火焰极高，可以融化一切物体。然而，它从来不攻击任何比它弱小的对手。可以用翅膀飞过相当于地上一千四百公尺高的距离，会喷出非常猛烈的火焰。','img/Pokemon/006Charizard.png'),
	...
	(NULL,'#012','巴大蝶','バタフリー','Butterfree','虫','飞','复眼',NULL,'有色眼镜','1.1m','32.0kg','仔细观察那对大眼睛的话，会发现其实是许许多多小眼睛聚集在一起形成的。如果被其他宝可梦袭击，就会一边挥洒有毒的鳞粉，一边拍动翅膀抵抗','img/Pokemon/012Butterfree.png'),
